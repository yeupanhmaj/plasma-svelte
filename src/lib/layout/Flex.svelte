<script lang="ts">
	...
	import { type PlasmaSpacing, resolveSpacing } from './utils.js'
	...
	const resolvedDirection = $derived(direction || (vertical ? 'column' : 'row'))
...
<div class="plasma-flex {customClass}" style={computedStyle} {...restProps}>
	{@render children?.()}
</div>
