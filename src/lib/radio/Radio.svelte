...
>
	...
	<span class="plasma-radio-circle" class:plasma-radio-circle--checked={isChecked}>
		<span class="plasma-radio-dot"></span>
	</span>

	{#if children}
		<span class="plasma-radio-label"> {@render children()} </span>
	{:else if label}
...
<style>
	...
	.plasma-radio-container:hover:not(.plasma-radio--disabled) .plasma-radio-circle {
	...
	.plasma-radio-container:hover:not(.plasma-radio--disabled) .plasma-radio-circle--checked {
