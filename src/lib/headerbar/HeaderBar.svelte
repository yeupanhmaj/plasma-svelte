...
<header class="plasma-headerbar {customClass}" {...restProps}>
	...
	<div class="plasma-headerbar-section plasma-headerbar-left">
		...
		{:else}
			{#if icon}
				<span class="plasma-headerbar-icon"> {@render icon()} </span>
			{/if}
			{#if title || subtitle}
		...
		{#if windowControls}
			<div class="plasma-headerbar-controls">
				...
				>
					<svg aria-hidden="true" viewBox="0 0 16 16" width="10" height="10" fill="currentColor">
						<path
							d="M2.5 3A1.5 1.5 0 0 0 1 4.5v7A1.5 1.5 0 0 0 2.5 13h11a1.5 1.5 0 0 0 1.5-1.5v-7A1.5 1.5 0 0 0 13.5 3h-11zm0 1h11a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-7a.5.5 0 0 1 .5-.5z"
						/>
					</svg>
				</button>
				<button
