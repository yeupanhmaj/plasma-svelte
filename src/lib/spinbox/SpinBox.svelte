	...
	<div class="plasma-spinbox-steppers">
		...
		>
			<svg aria-hidden="true" viewBox="0 0 16 16" width="10" height="10" fill="currentColor">
				<path
					d="M3.146 10.354a.5.5 0 0 1 0-.708l4.5-4.5a.5.5 0 0 1 .708 0l4.5 4.5a.5.5 0 0 1-.708.708L8 6.207l-4.146 4.147a.5.5 0 0 1-.708 0z"
				/>
			</svg>
		</button>
		<button
		...
		>
			<svg aria-hidden="true" viewBox="0 0 16 16" width="10" height="10" fill="currentColor">
				<path
					d="M3.146 5.646a.5.5 0 0 0 0 .708l4.5 4.5a.5.5 0 0 0 .708 0l4.5-4.5a.5.5 0 0 0-.708-.708L8 9.793 3.854 5.646a.5.5 0 0 0-.708 0z"
				/>
			</svg>
		</button>
	</div>
