...
>
	...
	{#if children}
		<span class="plasma-checkbox-label"> {@render children()} </span>
	{:else if label}
...
<style>
	...
	.plasma-checkbox-container:hover:not(.plasma-checkbox--disabled) .plasma-checkbox-box {
	...
	.plasma-checkbox-container:hover:not(.plasma-checkbox--disabled) .plasma-checkbox-box--checked,
